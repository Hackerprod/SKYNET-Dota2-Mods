	...
	public class AudioSessionManager
	{
		...
		public SimpleAudioVolume SimpleAudioVolume
		{
			get
			{
				...
				{
					audioSessionInterface.GetSimpleAudioVolume(Guid.Empty, 0u, out ISimpleAudioVolume audioVolume);
		...
		public AudioSessionControl AudioSessionControl
		{
			get
			{
				...
				{
					audioSessionInterface.GetAudioSessionControl(Guid.Empty, 0u, out IAudioSessionControl sessionControl);
		...
		public void RefreshSessions()
		{
			...
			{
				Marshal.ThrowExceptionForHR(audioSessionInterface2.GetSessionEnumerator(out IAudioSessionEnumerator sessionEnum));
